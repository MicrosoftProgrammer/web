...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><i class="fa fa-tags">&nbsp;</i>Advertisement</h1>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-list">&nbsp;</i>View Advertisement
                               <a class="pull-right" href="add_advertisement.php"><i class="fa fa-plus">&nbsp;</i>Add Advertisement</a>
                        </div>
                        <!-- /.panel-heading -->
    ...
    <!-- /#wrapper -->
     ...
     <?php fnColorBox(); ?>
     <script>
     function fnDelete(advertisementId)
     {
